      ...
      <div className="mx-auto my-4 grid grid-cols-1 gap-4 lg:grid-cols-2">
        <ProjectCard
          ...
          links={
            <>
              <a
                href="https://github.com/Teddy-94/personal-website"
                target="_blank"
              >
                <FaGithub />
              </a>
        ...
        <ProjectCard
          ...
          links={
            <>
              <a
                href="https://github.com/Teddy-94/cagr-calculator-browser-plugin"
                target="_blank"
              >
                <FaGithub />
              </a>
        ...
        <ProjectCard
          ...
          builtWith={
            <>
              <FaPython /> <SiRust /> <SiTypescript />{" "}
            </>
          }
          links={
            <>
              <a
                href="https://github.com/Teddy-94/advent-of-code"
                target="_blank"
              >
                <FaGithub />
              </a>
        ...
        <ProjectCard
          ...
          links={
            <>
              <a
                href="https://github.com/Teddy-94/.config-nvim"
                target="_blank"
              >
                <FaGithub />
              </a>
